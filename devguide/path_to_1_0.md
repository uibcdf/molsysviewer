...
| 26 | **Architecture rework and hardening** | In progress. Phases 0a–4b are audited; 5, 6, 8 and 9 are implemented awaiting audit; Phase 7 awaits two human observations. Phase 10 has closed notebook CI and implemented thin scene-state file helpers; dependency-channel closure, final installed-artifact reruns, hover semantics, dogfooding and the final matrix remain. See [`pending_proposals/pre_1_0_architecture_rework_and_hardening_master_plan.md`](pending_proposals/pre_1_0_architecture_rework_and_hardening_master_plan.md). |
