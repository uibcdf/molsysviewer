...
| 26 | **Architecture rework and hardening** | In progress. Phases 0a–6, 8 and 9 are audited; Phase 7 awaits visible-window Qt observations. Phase 10 has closed state-file persistence, hover semantics and public-callable digestion. The 0.22.4/0.23.4 pair passed 20/20 staging and public-channel installations; hosted core E2E, CI 7/7 and notebooks have since passed on `main` against public MolSysMT. These are pre-1.0 milestones, not final 1.0 artifact or human-workflow certification. Dogfooding, first-contact observation and exact 1.0 candidate reruns remain. See [`pre_1_0_architecture_rework_and_hardening_master_plan.md`](pre_1_0_architecture_rework_and_hardening_master_plan.md). |
