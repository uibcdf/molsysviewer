...
| save_state / load_state | `view.save_state`, `view.load_state`, `view.export_state`, `view.import_state` | 4 | 0 | MolSysViewer (Python authority) | — | 3 | 0 | stable | 0.19.0 |
...
| Popup | `view.build_popup_scene_snapshot` | 1 | 0 | MolSysViewer (Python authority) | [page](../docs/content/developer/standalone_surfaces.md) | 4 | 3 | stable | 0.20.1 |
...
| MolSysMT integration | `view.get`, `view.contains`, `view.is_composed_of`, `view.convert`, `view.extract` | 15 | 7 | MolSysMT (scientific authority) | [page](../docs/content/user/introduction/molsysmt.md) | 3 | 1 | stable | 0.19.0 |
