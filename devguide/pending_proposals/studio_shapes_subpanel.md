...
[UI design](studio_shapes_subpanel_ui_design.md) and the
[implementation plan](studio_shapes_subpanel_implementation_plan.md).

**Normative:** [`scene_objects_contracts.md`](scene_objects_contracts.md). This spec
