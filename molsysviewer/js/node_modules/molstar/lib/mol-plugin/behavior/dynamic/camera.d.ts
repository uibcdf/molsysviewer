...
export declare const FocusLoci: import("../../../mol-state/index.js").StateTransformer<PluginBehavior.Category, PluginBehavior.Behavior, PD.Values<{
    minRadius: PD.Numeric;
    extraRadius: PD.Numeric;
    durationMs: PD.Numeric;
    bindings: PD.Value<FocusLociBindings>;
}>>;
export declare const CameraAxisHelper: import("../../../mol-state/index.js").StateTransformer<PluginBehavior.Category, PluginBehavior.Behavior, {}>;
export declare const CameraControls: import("../../../mol-state/index.js").StateTransformer<PluginBehavior.Category, PluginBehavior.Behavior, PD.Values<{
    bindings: PD.Value<{
