...
const panels_1 = require("./ui/panels.js");
...
const select_1 = require("./behavior/select.js");
const states_1 = require("./ui/states.js");
...
const entities_1 = require("./ui/entities.js");
    ...
    static async create(elementOrId, options = {}) {
        ...
        const spec = {
            ...
            behaviors: [
                ...
                spec_2.PluginSpec.Behavior(behavior_1.PluginBehaviors.State.SnapshotControls),
