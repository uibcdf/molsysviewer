...
(function (Transform) {
    ...
    function setParamsHashVersion(t) {
        ...
        let version;
        try {
            version = (0, util_1.hashMurmur128o)((_a = t.params) !== null && _a !== void 0 ? _a : _emptyParams);
        }
        catch (_c) {
            const pToJson = t.transformer.definition.customSerialization
                ? t.transformer.definition.customSerialization.toJSON
                : _id;
            version = (0, util_1.hashMurmur128o)(pToJson((_b = t.params) !== null && _b !== void 0 ? _b : _emptyParams));
        }
        t.version = version;
    }
