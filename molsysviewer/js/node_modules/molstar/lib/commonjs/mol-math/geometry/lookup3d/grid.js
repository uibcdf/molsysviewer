...
const fibonacci_heap_1 = require("../../../mol-util/fibonacci-heap.js");
const memoize_1 = require("../../../mol-util/memoize.js");
const ray3d_1 = require("../primitives/ray3d.js");
...
function queryNearest(ctx, result) {
    ...
    tmpSetG.clear();
    tmpHeapG.clear();
    linear_algebra_1.Vec3.set(tmpRay.origin, x, y, z);
    if (!box3d_1.Box3D.containsVec3(box, tmpRay.origin)) {
        // intersect ray pointing to box center
        ray3d_1.Ray3D.targetTo(tmpRay, tmpRay, center);
        ray3d_1.Ray3D.intersectBox3D(tmpRay.origin, tmpRay, box);
