...
const symmetry_operator_1 = require("../../geometry/symmetry-operator.js");
var SpacegroupCell;
...
(function (Spacegroup) {
    ...
    function getSymmetryOperator(spacegroup, spgrOp, i, j, k) {
        ...
        return symmetry_operator_1.SymmetryOperator.create(symmetry_operator_1.SymmetryOperator.getSymmetryOperatorName(spgrOp, i, j, k), operator, { hkl: linear_algebra_1.Vec3.create(i, j, k), spgrOp });
    }
    ...
    function getSymmetryOperatorRef(spacegroup, spgrOp, i, j, k, ref) {
        ...
        return symmetry_operator_1.SymmetryOperator.create(symmetry_operator_1.SymmetryOperator.getSymmetryOperatorName(spgrOp, _i, _j, _k), operator, { hkl: linear_algebra_1.Vec3.create(_i, _j, _k), spgrOp });
    }
