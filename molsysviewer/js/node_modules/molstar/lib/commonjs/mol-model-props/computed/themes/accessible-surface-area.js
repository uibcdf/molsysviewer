...
const accessible_surface_area_1 = require("../accessible-surface-area.js");
...
exports.AccessibleSurfaceAreaColorThemeParams = {
    list: param_definition_1.ParamDefinition.ColorList('yellow-green-blue', { presetKind: 'scale' })
};
