...
const representation_2 = require("../../mol-plugin/behavior/dynamic/representation.js");
...
class ViewportHelpContent extends base_1.PluginUIComponent {
    ...
    render() {
        ...
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(!this.props.selectOnly && this.plugin.canvas3d) && (0, jsx_runtime_1.jsx)(HelpGroup, { header: 'Moving in 3D', children: (0, jsx_runtime_1.jsx)(BindingsHelp, { bindings: this.plugin.canvas3d.attribs.trackball.bindings }) }, 'trackball'), !!interactionBindings && (0, jsx_runtime_1.jsx)(HelpGroup, { header: 'Mouse & Key Controls', children: (0, jsx_runtime_1.jsx)(BindingsHelp, { bindings: interactionBindings }) }, 'interactions')] });
    }
}
