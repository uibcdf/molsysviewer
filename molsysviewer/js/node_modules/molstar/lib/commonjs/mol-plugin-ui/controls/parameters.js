...
function TextCtrl({ props, placeholder, update }) {
    ...
    if (props.param.multiline) {
        return (0, jsx_runtime_1.jsx)("div", { className: 'msp-control-text-area-wrapper', children: (0, jsx_runtime_1.jsx)("textarea", { value: value !== null && value !== void 0 ? value : '', placeholder: placeholder, disabled: props.isDisabled, onChange: onChange, onBlur: onBlur, onKeyDown: onKeyDown }) });
    }
    else {
        return (0, jsx_runtime_1.jsx)("input", { type: 'text', value: value !== null && value !== void 0 ? value : '', placeholder: placeholder, disabled: props.isDisabled, onChange: onChange, onBlur: onBlur, onKeyDown: onKeyDown });
    }
}
