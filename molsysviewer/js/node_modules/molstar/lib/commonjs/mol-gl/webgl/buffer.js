...
exports.createPixelPackBuffer = createPixelPackBuffer;
...
function getUsageHint(gl, usageHint) {
    switch (usageHint) {
        ...
        default: (0, type_helpers_1.assertUnreachable)(usageHint);
    }
}
...
function createPixelPackBuffer(gl, extensions, format, type) {
    let _buffer = getBuffer(gl);
    const _type = (0, texture_1.getType)(gl, extensions, type);
    const _format = (0, texture_1.getFormat)(gl, format, type);
    const _bpe = (0, texture_1.getBytesPerElement)(format, type);
    let _width = 0;
    let _height = 0;
