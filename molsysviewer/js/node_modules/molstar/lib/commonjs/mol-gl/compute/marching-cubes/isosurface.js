...
const reduction_1 = require("../histogram-pyramid/reduction.js");
const tables_1 = require("./tables.js");
const quad_vert_1 = require("../../../mol-gl/shader/quad.vert.js");
const isosurface_frag_1 = require("../../../mol-gl/shader/marching-cubes/isosurface.frag.js");
const active_voxels_1 = require("./active-voxels.js");
...
const IsosurfaceSchema = {
    ...
    uGridDataDim: (0, schema_1.UniformSpec)('v3'),
    uGridTransform: (0, schema_1.UniformSpec)('m4'),
    uGridTransformAdjoint: (0, schema_1.UniformSpec)('m3'),
...
function getIsosurfaceRenderable(ctx, activeVoxelsPyramid, activeVoxelsBase, volumeData, gridDim, gridTexDim, gridDataDim, transform, isoValue, levels, scale, count, invert, packedGroup, axisOrder, constantGroup) {
    if (ctx.namedComputeRenderables[IsosurfaceName]) {
        ...
        mol_util_1.ValueCell.update(v.uGridDataDim, gridDataDim);
        mol_util_1.ValueCell.update(v.uGridTransform, transform);
        mol_util_1.ValueCell.update(v.uGridTransformAdjoint, linear_algebra_1.Mat3.adjointFromMat4((0, linear_algebra_1.Mat3)(), transform));
...
function createIsosurfaceRenderable(ctx, activeVoxelsPyramid, activeVoxelsBase, volumeData, gridDim, gridTexDim, gridDataDim, transform, isoValue, levels, scale, count, invert, packedGroup, axisOrder, constantGroup) {
    ...
    const values = {
        ...
        uGridDataDim: mol_util_1.ValueCell.create(gridDataDim),
        uGridTransform: mol_util_1.ValueCell.create(transform),
        uGridTransformAdjoint: mol_util_1.ValueCell.create(linear_algebra_1.Mat3.adjointFromMat4((0, linear_algebra_1.Mat3)(), transform)),
