...
function lociLabel(loci, options = {}) {
    ...
    switch (loci.kind) {
        ...
        case 'cell-loci':
            ...
            const start = int_1.OrderedSet.start(loci.elements[0].indices);
            ...
            if (size === 1) {
                if (loci.volume.instances.length > 1) {
                    label.push(`Instance #${int_1.OrderedSet.start(loci.elements[0].instances) + 1}`);
                }
        ...
        case 'segment-loci':
            ...
            const firstSegment = int_1.OrderedSet.start(loci.elements[0].segments);
