...
async function doMesh(volume, filename) {
    const mesh = await mol_task_1.Task.create('', runtime => (0, isosurface_1.createVolumeIsosurfaceMesh)({ runtime }, volume, -1, theme_1.Theme.createEmpty(), { isoValue: volume_1.Volume.IsoValue.absolute(1.5), wrap: 'auto' })).run();
