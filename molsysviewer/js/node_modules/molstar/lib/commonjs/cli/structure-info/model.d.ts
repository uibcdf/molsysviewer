...
import { Model, Structure, Trajectory } from '../../mol-model/structure.js';
export declare function readCifFile(path: string): Promise<import("../../mol-io/reader/cif.js").CifBlock>;
