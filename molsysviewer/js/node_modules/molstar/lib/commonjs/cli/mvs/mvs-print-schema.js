...
const tree_validation_1 = require("../../extensions/mvs/tree/generic/tree-validation.js");
const mvs_tree_1 = require("../../extensions/mvs/tree/mvs/mvs-tree.js");
...
function main(args) {
    if (args.markdown) {
        console.log((0, tree_validation_1.treeSchemaToMarkdown)(mvs_tree_1.MVSTreeSchema));
    }
    else {
        console.log((0, tree_validation_1.treeSchemaToString)(mvs_tree_1.MVSTreeSchema));
    }
}
main(parseArguments());
