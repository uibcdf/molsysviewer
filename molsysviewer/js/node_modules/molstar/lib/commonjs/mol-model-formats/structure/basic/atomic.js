...
const atom_site_operator_mapping_1 = require("../../../mol-model/structure/export/categories/atom_site_operator_mapping.js");
const atomic_1 = require("../../../mol-model/structure/model/properties/atomic.js");
const atomic_derived_1 = require("../../../mol-model/structure/model/properties/utils/atomic-derived.js");
const atomic_index_1 = require("../../../mol-model/structure/model/properties/utils/atomic-index.js");
...
const mmcif_1 = require("../mmcif.js");
...
function getResidueSourceIndex(atomSourceIndex, nResidues, residueOffsets) {
    ...
    const sortedResidues = (0, array_1.range)(nResidues).sort((ia, ib) => residueSourceIndex[ia] - residueSourceIndex[ib]);
    ...
    return db_1.Column.ofIntArray(residueSourceIndex);
}
