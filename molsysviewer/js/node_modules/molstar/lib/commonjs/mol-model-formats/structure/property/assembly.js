...
const symmetry_1 = require("../../../mol-model/structure/model/properties/symmetry.js");
const structure_1 = require("../../../mol-model/structure.js");
const structure_2 = require("../../../mol-model/structure.js");
...
function operatorGroupsProvider(generators, matrices) {
    return () => {
        ...
        for (let i = 0; i < generators.length; i++) {
            ...
            const selector = structure_1.Queries.generators.atoms({
                chainTest: structure_1.Queries.pred.and(structure_1.Queries.pred.eq(ctx => structure_2.StructureProperties.unit.operator_name(ctx.element), symmetry_operator_1.SymmetryOperator.DefaultName), structure_1.Queries.pred.inSet(ctx => structure_2.StructureProperties.chain.label_asym_id(ctx.element), gen.asymIds))
            });
...
function getAssemblyOperators(matrices, operatorNames, startIndex, assemblyId) {
    ...
    for (const op of operatorNames) {
        ...
        const canonicalOpName = symmetry_operator_1.SymmetryOperator.getAssemblyOperatorName(op);
        operators[operators.length] = symmetry_operator_1.SymmetryOperator.create(opName, m, { instanceId: canonicalOpName, assembly: { id: assemblyId, operId: index, operList: op } });
    }
    return operators;
}
