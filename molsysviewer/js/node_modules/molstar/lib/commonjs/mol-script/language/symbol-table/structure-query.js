...
const Core = tslib_1.__importStar(require("./core.js"));
const symbol_1 = require("../symbol.js");
...
const atomProperty = {
    ...
    core: {
        ...
        instanceId: atomProp(type_1.Type.Str, 'Canonical name of the symmetry operator applied to this element.'),
        ...
        modelEntryId: atomProp(type_1.Type.Str, 'Entry ID of the model (e.g., PDB ID).')
    },
    topology: {
    ...
    macromolecular: {
        ...
        residueSourceIndex: atomProp(type_1.Type.Num),
