...
const DataFormat = tslib_1.__importStar(require("../../common/data-format.js"));
const Coords = tslib_1.__importStar(require("../algebra/coordinate.js"));
const Box = tslib_1.__importStar(require("../algebra/box.js"));
const console_logger_1 = require("../../../../mol-util/console-logger.js");
const state_1 = require("../state.js");
const identify_1 = require("./identify.js");
const compose_1 = require("./compose.js");
const encode_1 = require("./encode.js");
...
async function createDataContext(file) {
    ...
    return {
        file,
        header,
        spacegroup: geometry_1.SpacegroupCell.create(header.spacegroup.number || 'P 1', linear_algebra_1.Vec3.ofArray(header.spacegroup.size), linear_algebra_1.Vec3.scale(linear_algebra_1.Vec3.zero(), linear_algebra_1.Vec3.ofArray(header.spacegroup.angles), Math.PI / 180)),
