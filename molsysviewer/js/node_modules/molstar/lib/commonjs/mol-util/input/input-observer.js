...
(function (InputObserver) {
    function create(props = {}) {
        ...
        return {
            ...
            updateTrackedPointers: mol_util_1.noop,
            updateScreenTouches: mol_util_1.noop,
    ...
    function fromElement(element, props = {}) {
        ...
        const trackedPointerState = {
            primary: { prev: undefined, down: (0, linear_algebra_1.Vec2)(), end: (0, linear_algebra_1.Vec2)(), axes: [] },
            secondary: { prev: undefined, down: (0, linear_algebra_1.Vec2)(), end: (0, linear_algebra_1.Vec2)(), axes: [] },
            distance: -1,
        };
        ...
        function handleTrackedPointer(trackedPointer, isSecondary) {
            ...
            if (prevPressed && !pressed) {
                linear_algebra_1.Vec2.set(state.end, x, y);
                if (linear_algebra_1.Vec2.distance(state.end, state.down) < 20) {
            ...
            if (pressed) {
                ...
                if (isStart) {
                    linear_algebra_1.Vec2.set(state.down, x, y);
                }
            }
        ...
        function handleTrackedPointerGesture(primary, left, button) {
            const d = linear_algebra_1.Vec3.distance(primary.ray.origin, left.ray.origin);
        ...
        function handleScreenTouches(screenTouches) {
            if (screenTouches.length === 2) {
                const a = linear_algebra_1.Vec2.fromObj(screenTouches[0]);
                const b = linear_algebra_1.Vec2.fromObj(screenTouches[1]);
                const d = linear_algebra_1.Vec2.distance(a, b);
            ...
            if (!t) {
                if (screenTouchStart && screenTouchPrev) {
                    const a = linear_algebra_1.Vec2.fromObj(screenTouchStart);
                    const b = linear_algebra_1.Vec2.fromObj(screenTouchPrev);
                    if (linear_algebra_1.Vec2.distance(a, b) < 10) {
                        const [x, y] = a;
                        const [pageX, pageY] = [x, y];
                        const modifiers = ModifiersKeys.create();
                        const button = ButtonsType.Flag.Trigger;
            ...
            const p = linear_algebra_1.Vec2.fromObj(t);
            const [x, y] = p;
            const [pageX, pageY] = [x, y];
            const modifiers = ModifiersKeys.create();
            const button = ButtonsType.Flag.Trigger;
