...
export declare function pickObjectKeysWithRemapping<V>(obj: Record<string, V>, keys: string[], remapping: Record<string, string | null>): Record<string, V>;
export declare function objectOfArraysToArrayOfObjects<T extends object>(objectOfArrays: {
