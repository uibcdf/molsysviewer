...
const hsl_1 = require("./spaces/hsl.js");
...
(function (Color) {
    ...
    const _interpolateHsl1 = hsl_1.Hsl.zero();
    const _interpolateHsl2 = hsl_1.Hsl.zero();
    /** Linear interpolation between two colors in HSL space */
    function interpolateHsl(c1, c2, t) {
        const hsl1 = hsl_1.Hsl.fromColor(_interpolateHsl1, c1);
        const hsl2 = hsl_1.Hsl.fromColor(_interpolateHsl2, c2);
        hsl_1.Hsl.interpolate(hsl1, hsl1, hsl2, t);
        return hsl_1.Hsl.toColor(hsl1);
    }
