 ...
 */
export declare function readFile(file: File, isBinary?: boolean): Promise<string | Uint8Array<ArrayBufferLike>>;
...
export declare function readUrl(url: string, isBinary: boolean): Promise<string | Uint8Array<ArrayBuffer>>;
