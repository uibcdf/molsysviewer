...
exports.pickObjectKeysWithRemapping = pickObjectKeysWithRemapping;
exports.objectOfArraysToArrayOfObjects = objectOfArraysToArrayOfObjects;
...
function pickObjectKeysWithRemapping(obj, keys, remapping) {
    const result = {};
    for (const key of keys) {
...
function objectOfArraysToArrayOfObjects(objectOfArrays) {
    let n = undefined;
