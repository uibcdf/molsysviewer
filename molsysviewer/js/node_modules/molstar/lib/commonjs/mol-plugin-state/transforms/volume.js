...
exports.VolumeInstances = exports.VolumeTransform = exports.VolumeFromSegmentationCif = exports.VolumeFromDensityServerCif = exports.AssignColorVolume = exports.VolumeFromDx = exports.VolumeFromCube = exports.VolumeFromDsn6 = exports.VolumeFromCcp4 = void 0;
...
exports.VolumeInstances = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply({ a, params }) {
        ...
        const instances = params.transforms.map(t => ({ transform: (0, helpers_1.getTransformFromParams)(t.transform, center) }));
        if (!instances.length) {
            return a;
        }
        return new objects_1.PluginStateObject.Volume.Data({
