...
const api_1 = require("./volseg-api/api.js");
const utils_1 = require("./volseg-api/utils.js");
const entry_meshes_1 = require("./entry-meshes.js");
const entry_models_1 = require("./entry-models.js");
const entry_segmentation_1 = require("./entry-segmentation.js");
const entry_state_1 = require("./entry-state.js");
const entry_volume_1 = require("./entry-volume.js");
const ExternalAPIs = tslib_1.__importStar(require("./external-api.js"));
const global_state_1 = require("./global-state.js");
...
class VolsegEntryData extends behavior_1.PluginBehavior.WithSubscribers {
    ...
    getSegmentIdFromLoci(loci) {
        ...
        if (volume_1.Volume.Segment.isLoci(loci) && loci.volume._propertyData.ownerId === this.ref) {
            if (loci.elements.length === 1 && int_1.OrderedSet.size(loci.elements[0].segments) === 1) {
                return int_1.OrderedSet.start(loci.elements[0].segments);
            }
        }
