...
const tree_utils_1 = require("./tree-utils.js");
...
function treeValidationIssues(schema, tree, options = {}) {
    ...
    const issues = (0, params_schema_1.paramsValidationIssues)(nodeSchema.params, (0, tree_schema_1.getParams)(tree), options);
    if (issues)
    ...
    for (const child of (0, tree_schema_1.getChildren)(tree)) {
...
function validateTree(schema, tree, label, plugin) {
