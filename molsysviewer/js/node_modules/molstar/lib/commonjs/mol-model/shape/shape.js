...
const geometry_2 = require("../../mol-math/geometry.js");
const centroid_helper_1 = require("../../mol-math/geometry/centroid-helper.js");
const shape_group_1 = require("../../mol-theme/size/shape-group.js");
const shape_group_2 = require("../../mol-theme/color/shape-group.js");
...
(function (Shape) {
    function create(name, sourceData, geometry, getColor, getSize, getLabel, transforms, groupCount) {
        return {
            ...
            get groupCount() {
                return groupCount !== null && groupCount !== void 0 ? groupCount : geometry_1.Geometry.getGroupCount(geometry);
            },
            getColor,
            getSize,
            getLabel
