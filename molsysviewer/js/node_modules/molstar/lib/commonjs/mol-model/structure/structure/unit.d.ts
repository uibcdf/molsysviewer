...
declare namespace Unit {
    ...
    export function getModelHierarchyOfKind(kind: Unit.Kind, model: Model): CoarseElements | import("../model/properties/atomic.js").AtomicHierarchy;
    export function getHierarchy(u: Unit): CoarseElements | import("../model/properties/atomic.js").AtomicHierarchy;
    export {};
}
export { Unit };
