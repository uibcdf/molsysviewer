...
import { ArrowDownwardSvg, ArrowDropDownSvg, ArrowRightSvg, ArrowUpwardSvg, BookmarksOutlinedSvg, CheckSvg, ClearSvg, DeleteOutlinedSvg, HelpOutlineSvg, Icon, MoreHorizSvg, WarningSvg } from './icons.js';
...
function TextCtrl({ props, placeholder, update }) {
    ...
    if (props.param.multiline) {
        return _jsx("div", { className: 'msp-control-text-area-wrapper', children: _jsx("textarea", { value: value !== null && value !== void 0 ? value : '', placeholder: placeholder, disabled: props.isDisabled, onChange: onChange, onBlur: onBlur, onKeyDown: onKeyDown }) });
    }
    else {
        return _jsx("input", { type: 'text', value: value !== null && value !== void 0 ? value : '', placeholder: placeholder, disabled: props.isDisabled, onChange: onChange, onBlur: onBlur, onKeyDown: onKeyDown });
    }
}
