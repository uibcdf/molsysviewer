...
import { SelectLoci } from '../../mol-plugin/behavior/dynamic/representation.js';
import { FocusLoci } from '../../mol-plugin/behavior/dynamic/representation.js';
import { Icon, ArrowDropDownSvg, ArrowRightSvg, CameraSvg } from '../controls/icons.js';
...
export class ViewportHelpContent extends PluginUIComponent {
    ...
    render() {
        ...
        return _jsxs(_Fragment, { children: [(!this.props.selectOnly && this.plugin.canvas3d) && _jsx(HelpGroup, { header: 'Moving in 3D', children: _jsx(BindingsHelp, { bindings: this.plugin.canvas3d.attribs.trackball.bindings }) }, 'trackball'), !!interactionBindings && _jsx(HelpGroup, { header: 'Mouse & Key Controls', children: _jsx(BindingsHelp, { bindings: interactionBindings }) }, 'interactions')] });
    }
}
