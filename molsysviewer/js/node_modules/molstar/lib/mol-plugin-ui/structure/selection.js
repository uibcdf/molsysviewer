...
import { getElementQueries, getNonStandardResidueQueries, getPolymerAndBranchedEntityQueries, StructureSelectionQueries } from '../../mol-plugin-state/helpers/structure-selection-query.js';
...
import { compileIdListSelection } from '../../mol-script/util/id-list.js';
...
import { Button, ControlGroup, IconButton, ToggleButton } from '../controls/common.js';
import { BrushSvg, CancelOutlinedSvg, CloseSvg, CubeOutlineSvg, HelpOutlineSvg, Icon, IntersectSvg, RemoveSvg, RestoreSvg, SelectionModeSvg, SetSvg, SubtractSvg, UnionSvg } from '../controls/icons.js';
import { ParameterControls, PureSelectControl } from '../controls/parameters.js';
import { HelpGroup, HelpText, ViewportHelpContent } from '../viewport/help.js';
import { AddComponentControls } from './components.js';
