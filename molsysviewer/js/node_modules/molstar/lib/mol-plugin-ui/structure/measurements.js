...
import { StructureMeasurementParams } from '../../mol-plugin-state/manager/structure/measurement.js';
import { PluginCommands } from '../../mol-plugin/commands.js';
import { PluginConfig } from '../../mol-plugin/config.js';
import { angleLabel, dihedralLabel, distanceLabel, lociLabel, structureElementLociLabelMany } from '../../mol-theme/label.js';
import { CollapsableControls, PurePluginUIComponent } from '../base.js';
import { ActionMenu } from '../controls/action-menu.js';
import { Button, ExpandGroup, IconButton, ToggleButton } from '../controls/common.js';
import { AddSvg, ArrowDownwardSvg, ArrowUpwardSvg, DeleteOutlinedSvg, HelpOutlineSvg, Icon, MoreHorizSvg, PencilRulerSvg, SetSvg, TuneSvg, VisibilityOffOutlinedSvg, VisibilityOutlinedSvg } from '../controls/icons.js';
