...
import { getStructureThemeTypes } from '../../mol-plugin-state/helpers/structure-representation-params.js';
...
import { Button, ExpandGroup, IconButton, ToggleButton, ControlRow, TextInput } from '../controls/common.js';
import { CubeOutlineSvg, IntersectSvg, SetSvg, SubtractSvg, UnionSvg, BookmarksOutlinedSvg, AddSvg, TuneSvg, RestoreSvg, VisibilityOffOutlinedSvg, VisibilityOutlinedSvg, DeleteOutlinedSvg, MoreHorizSvg, CheckSvg } from '../controls/icons.js';
import { ParameterControls } from '../controls/parameters.js';
import { UpdateTransformControl } from '../state/update-transform.js';
import { GenericEntryListControls } from './generic.js';
