 ...
 */
import { DownloadFile } from '../../mol-plugin-state/actions/file.js';
import { DownloadStructure, LoadTrajectory } from '../../mol-plugin-state/actions/structure.js';
import { DownloadDensity } from '../../mol-plugin-state/actions/volume.js';
import { CoordinatesFormatCategory } from '../../mol-plugin-state/formats/coordinates.js';
import { TopologyFormatCategory } from '../../mol-plugin-state/formats/topology.js';
import { TrajectoryFormatCategory } from '../../mol-plugin-state/formats/trajectory.js';
import { VolumeFormatCategory } from '../../mol-plugin-state/formats/volume.js';
import { CollapsableControls } from '../../mol-plugin-ui/base.js';
import { Button } from '../../mol-plugin-ui/controls/common.js';
import { OpenInBrowserSvg } from '../../mol-plugin-ui/controls/icons.js';
import { ParameterControls } from '../../mol-plugin-ui/controls/parameters.js';
import { formatBytes } from '../../mol-util/index.js';
