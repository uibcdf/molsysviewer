 ...
 */
import { bool, dict, float, int, nullable, OptionalField, RequiredField, str, union } from '../generic/field-schema.js';
import { SimpleParamsSchema, UnionParamsSchema } from '../generic/params-schema.js';
import { ColorT, FloatList, IntList, PrimitivePositionT, Vector3 } from './param-types.js';
const _TubeBase = {
