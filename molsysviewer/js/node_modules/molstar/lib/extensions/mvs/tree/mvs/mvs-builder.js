 ...
 */
import { deepClone, pickObjectKeys } from '../../../../mol-util/object.js';
import { GlobalMetadata } from '../../mvs-data.js';
...
export class Root extends _Base {
    ...
    getSnapshot(metadata) {
        return {
            root: deepClone(this._node),
            metadata: { ...metadata },
            animation: (this === null || this === void 0 ? void 0 : this._animation) ? deepClone(this._animation.node) : undefined,
        };
    }
