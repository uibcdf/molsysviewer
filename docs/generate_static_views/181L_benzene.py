...
view = msv.new_view('181L', selection='molecule_type not in ["water", "ion"]')
...
view.show()
view.export.html("../_static/views/181L_benzene.html", title="181L", shared_runtime="../_static", background="transparent")
