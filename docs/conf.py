...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', '**.ipynb_checkpoints', 'old_api', 'freezer', 'AGENTS.md']
...
htmlhelp_basename = 'molsysviewerdoc'
