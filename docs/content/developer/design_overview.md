...
This page preserves the original high-level design overview written during the
initial architecture phase.
It is intentionally verbose and forward-looking.
...
This file defines a long-term blueprint for MolSysViewer’s evolution.
