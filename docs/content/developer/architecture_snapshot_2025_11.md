...
This page preserves a detailed, implementation-oriented snapshot written during the initial architecture phase.
It is not the source of truth, but it is useful when you need a compact description of the data flow and message protocol.
