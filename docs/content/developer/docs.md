...
- Runtime CDN: docs-light exports can fall back to the npm package `@uibcdf/molsysviewer` (served by jsDelivr). Publishing is handled by the Trusted Publisher workflow in `.github/workflows/npm-publish.yml`.
